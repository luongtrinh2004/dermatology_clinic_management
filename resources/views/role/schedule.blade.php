                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @if($appointment->status === 'approved')
                            <a href="{{ route('admindoctor.medicalrecords.create', ['appointment_id' => $appointment->id]) }}" class="btn btn-success btn-sm">
                                Tạo Hồ Sơ Bệnh Án
                            </a>
                            @elseif($appointment->status === 'pending')
                            <button class="btn btn-secondary btn-sm" disabled>Chờ duyệt</button>
                            @else
                            <button class="btn btn-secondary btn-sm" disabled>Đã từ chối</button>
                            @endif
                        </td>
                    </tr>
                    @endforeach
