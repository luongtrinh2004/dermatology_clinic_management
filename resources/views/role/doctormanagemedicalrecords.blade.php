            ...
            @endif
                <div class="row">
                    ...
                    <div class="col-md-4 mb-2">
                        ...
                        <input type="hidden" name="doctor_id" id="doctor_id" value="{{ $doctor ? $doctor->id : (auth()->user()->doctor ? auth()->user()->doctor->id : '') }}">
                        <input type="text" class="form-control" value="{{ $doctor ? $doctor->name : (auth()->user()->doctor ? auth()->user()->doctor->name : '') }}" readonly>
                    </div>
                ...
                <table class="table table-bordered mt-4">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $record['cccd'] }}</td>
                            <td>
                                <button class="btn btn-info btn-sm view-pdf" data-cccd="{{ $record['cccd'] }}" data-id="{{ $record['cid'] }}">Xem</button>
