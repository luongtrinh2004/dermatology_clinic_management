    ...
    <header>
        <div class="py-3" style="background-color: #e0f7fa; border-bottom: 1px solid #ccc;">
            <div class="container d-flex justify-content-center align-items-center flex-wrap gap-3">
                ...
                <a href="/support" class="btn btn-warning btn-sm rounded-pill px-3" style="color: white;">Hướng dẫn khách hàng</a>
                
                <!-- Phần đăng nhập/đăng xuất -->
                @guest
                    <a href="{{ route('login') }}" class="btn btn-success btn-sm rounded-pill px-3">Đăng nhập</a>
                @endguest

                @auth
                <form action="{{ route('logout') }}" 
                    method="POST" 
                    class="d-inline-block m-0 p-0 align-middle" 
                    style="vertical-align: middle;">
                    @csrf
                    <button type="submit" 
                            class="btn btn-danger btn-sm rounded-pill px-3 align-middle" 
                            style="vertical-align: middle;">
                        Đăng xuất
                    </button>
                </form>
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link" href="{{ url('/about') }}"
                            style="color: #0056b3; font-family: 'Poppins', sans-serif; font-size: 14px; font-weight: 500; margin: 0 10px;">About Us</a></li>
