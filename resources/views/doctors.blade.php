                                ...
                                <div class="text-start mx-auto px-3 py-2 rounded info-box" style="max-width: 450px;">
                                    ...
                                    <ul>
                                        @foreach($workingHours as $schedule)
                                            <li>{{ __('Thứ') }}
                                                {{ $schedule['day'] == 'Monday' ? 'Hai' : ($schedule['day'] == 'Tuesday' ? 'Ba' : ($schedule['day'] == 'Wednesday' ? 'Tư' : ($schedule['day'] == 'Thursday' ? 'Năm' : ($schedule['day'] == 'Friday' ? 'Sáu' : ($schedule['day'] == 'Saturday' ? 'Bảy' : 'Chủ Nhật'))))) }}:
